...
<body>
    <header>
        ...
        <div class="login"><a href="log_out.php">ログイン</a></div>
    </header>

    <main>
        <form action="mypage.php" method="post">
            <div class="form_contents">
                <!--前回「ログイン状態を保持する」にチェックを入れていた場合、
                メールアドレスとパスワードの入力項目にcookieから値を呼び出して
                表示させる -->
                <div class="mail">
                ...
                <div class="login_check">
                    <!--前回チェックを入れた場合、自動的にチェックが入るように
                    cookieにlogin_keepが存在するかissetで判定する。 -->
