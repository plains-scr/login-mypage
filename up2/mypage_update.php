...
//preparedステートメント(update)でSQL文をセット$ //bindValueメソッドでパラメータをセット
...
//preparedステートメントでSQL文をセット(更新された情報をDBからselect文で取得)$ //bindValueメソッドでパラメータをセット
...
//mypage.phpへリダイレクト
header("Location:http://localhost/up2/mypage.php");
